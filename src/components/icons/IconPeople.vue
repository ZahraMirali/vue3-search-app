<template>
  <svg height="256" width="256" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      fill="currentColor"
    ></path>
    <path d="M1224-790V894H-560V-790h1784m8-8H-568V902h1800V-798z" fill="currentColor"></path>
  </svg>
</template>
